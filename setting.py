...
##################################################################
# 版本号配置
GB_VERSION = "Ver 0.3.2 2023-07-05 23:50"
##################################################################
...
##################################################################
# 账号密码目录
GB_RULE_DICT_DIR = GB_BASE_DIR.joinpath("dict")
# 账号密码字典文件的格式
GB_NAME_FILE = str(GB_RULE_DICT_DIR.joinpath("mode1_name.txt"))
GB_PASS_FILE = str(GB_RULE_DICT_DIR.joinpath("mode1_pass.txt"))
# 账号密码对文件命名格式
GB_PAIR_FILE = str(GB_RULE_DICT_DIR.joinpath("mode2_pairs.txt"))

# 账号密码对文件 连接符号
GB_PAIR_LINK = ':'

# 使用账号、密码文件进行爆破
GB_NAME_PASS_FILE = True
